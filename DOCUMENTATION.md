...
- **Mobile bottom nav (TopNav):** **floating frosted pill** (2026-06-13) — inset 14px from the screen edges, `borderRadius 28`, blur 20, soft drop shadow, floats `safe-area-bottom + 10px` above the bottom; icon + 12/600 label, active = ink label + a small **orange dot** below it. Top bar on mobile is a transparent **absolute overlay** (logo, bell, avatar) floating over the hero.
