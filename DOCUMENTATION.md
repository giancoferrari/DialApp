...
### Feel / interaction polish (Phases 1–3)
...
Remaining phases (not yet built): **4** motion with intent (directional transitions, post→detail expand, one spring-easing standard), **5** consistency / design tokens (shared Avatar/timeAgo/formatters/EmptyState, feed aspect-ratio), **6** full onboarding flow, **7** social feel (comments bottom sheet, profile polish). Streaks deferred (needs data plumbing).

_Last updated: 2026-06-03 — **Phases 1–3 of the "feel" effort** complete (see section above). Earlier: comment likes/replies, tappable friends count, post tagging + reposts, full notifications, 3-dot post menu, expanded Terms/Privacy. 
