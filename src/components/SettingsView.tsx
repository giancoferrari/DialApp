...
function Card({ children }: { children: React.ReactNode }) {
  return (
    <div style={{ background: 'rgba(250,246,234,0.62)', backdropFilter: 'blur(24px) saturate(160%)', WebkitBackdropFilter: 'blur(24px) saturate(160%)', border: '1px solid rgba(255,255,255,0.52)', borderRadius: 18, overflow: 'hidden', boxShadow: '0 4px 20px rgba(31,29,23,0.07), inset 0 1px 0 rgba(255,255,255,0.65)' }}>
      {children}
    </div>
  )
}
...
export default function SettingsView({ profile, userEmail, userId, onProfileSaved, onSignOut, onShowLegal, isMobile = false }: Props) {
  ...
  return (
    <div style={{ maxWidth: 640, margin: '0 auto', padding: `${isMobile ? 28 : 48}px ${px}px ${isMobile ? 120 : 80}px` }}>
      ...
      {/* ── Page title ── */}
      <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.12em', color: '#D9824D', textTransform: 'uppercase', marginBottom: 8 }}>Account</div>
