...
export default function StatsView({ rounds, shots, isMobile = false, onNavigate }: Props) {
  ...
  return (
    <div ref={ref} style={{ maxWidth: 680, margin: '0 auto', padding: `${isMobile ? 24 : 44}px ${px}px ${isMobile ? 120 : 80}px` }}>
      ...
      <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.12em', color: '#D9824D', textTransform: 'uppercase', marginBottom: 8 }}>Your game</div>
          ...
          return (
            <div key={m.label} style={{ ...card, padding: '16px 18px' }}>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 3 }}>
                <span style={{ fontFamily: "'Bricolage Grotesque', sans-serif", fontSize: 30, fontWeight: 700, color: has ? '#1F1D17' : '#C9C0A8', letterSpacing: '-0.04em', lineHeight: 1 }}>
                  {has ? m.value : '—'}
                </span>
